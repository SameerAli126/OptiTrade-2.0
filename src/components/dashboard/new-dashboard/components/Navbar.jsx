...
const Navbar = () => {
    ...
    const userBalance = 10000; // Replace this with the actual balance from your state or context
    ...
    return (
        <div className="flex justify-between p-2 md:ml-6 md:mr-6 relative border-b border-[#02a1ac] dark:border-[#02a1ac]">
            ...
            <div className="flex">
                <BalanceDisplay balance={userBalance} /> {/* Add the BalanceDisplay component here */}
